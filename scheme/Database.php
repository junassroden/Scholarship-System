...
class Database {
    ...
    // Show SQL if available (safe check)
    if (isset($this) && property_exists($this, 'getSQL')) {
    ...
    // If you want to see the SQL query too
    if (property_exists($this, 'getSQL')) {
        $errorDetails .= "<br>Query: " . $this->getSQL;
    }

    // Show directly (for debugging)
    echo "<h1>500 Internal Server Error</h1>";
    echo "<div style='font-family:monospace;color:red;padding:10px;border:1px solid #ccc;background:#f9f9f9'>";
    echo $errorDetails;
    echo "</div>";
